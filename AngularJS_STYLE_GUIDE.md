...
## Отступы и табуляция
* В качестве отступов используется символ табуляции, по размеру равный четырём символам пробела.
...
В прошлом секции можно было заметить что каждому компоненту соответствует отдельный файл, что и является рекомендуемой практикой для данного проекта.
...
* Выносите логику из контроллеров, делегируя её сервисам и фабрика.
